...
#| label: Q2plot1(Breach method by sector)
#| echo: false
#| warning: false
...
```{r}
#| label:  Q2plot2(Breach method by sector by year)
#| echo: false
#| warning: false
...
-   Vulnerable Sectors: Sectors consistently appearing with larger points over time might be more susceptible to breaches.
-   Year-to-Year Fluctuations: You can see if specific sectors experience a surge or decline in breach activity over the years. Combined Insights: By considering both sector position and size changes over time, you can identify periods where certain sectors were disproportionately impacted by breaches.
:::
:::
...
Verizon Data Breach Investigations Report (Annual Report)

```         
-   A comprehensive report analyzing data breaches and cybersecurity incidents from various industries worldwide
```

-   Industry Reports/White Papers:

Data Breach Trends and Predictions (Annual Report) by Experian

```         
-   Provides insights into data breach trends and predictions based on analysis of real-world incidents.
```

-   Academic/Journal Articles:

Leukfeldt, E. R., & Holt, T. J. (2020). Cybercrime by cash, corporations or nation-states: An overview of the digital underground market economy. Criminology and Criminal Justice, 20(5), 505-524.

```         
-   Discusses the digital underground market economy and its role in facilitating cybercrime, including data breaches.
```
:::
