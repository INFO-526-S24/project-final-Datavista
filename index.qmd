...
knitr::opts_chunk$set(
  ...
  dpi = 200,            # higher dpi, sharper image{r load_packages, message=FALSE, include=FALSE}
...
# Combine animations
#animation::saveGIF({  # Save animations as GIF
#  print(total_animation)  # Print total_animation
#  print(sector_group_animation)  # Print sector_group_animation
#}, movie.name = "combined_animation.gif", interval = 0.5)  # Save as GIF with 0.5s interval
