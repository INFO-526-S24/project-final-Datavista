...
# Calculating total breaches for each method in 2018
...
# Calculating total breaches for each method in 2023
...
data_2023 <- data[data$year == 2023, ]
data_2023
records_lost_2023 <- sum(data_2023$records.lost, na.rm = TRUE)
records_lost_2023
...
```{r}
#| content: valuebox
#| title: "Total record lost in 2023"
# Load the data
...
```{r}
#| title: Breaches over Time by  method
# Load necessary libraries
# Load necessary libraries
library(dplyr)
library(plotly)
